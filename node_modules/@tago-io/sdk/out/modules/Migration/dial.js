    ...
    if (Array.isArray(oldWidget.data)) {
        for (const item of oldWidget.data) {
            ...
            for (const variable of item.variables) {
                ...
                if (((_e = oldDisplay.vars_formula) === null || _e === void 0 ? void 0 : _e[key]) && !((_f = newStructure.display) === null || _f === void 0 ? void 0 : _f.formula)) {
                    newStructure.display.formula = common_1.convertFormula((_g = oldDisplay.vars_formula) === null || _g === void 0 ? void 0 : _g[key]);
                }
                if (((_h = oldDisplay === null || oldDisplay === void 0 ? void 0 : oldDisplay.vars_labels) === null || _h === void 0 ? void 0 : _h[key]) && ((_j = oldDisplay === null || oldDisplay === void 0 ? void 0 : oldDisplay.vars_labels) === null || _j === void 0 ? void 0 : _j[key]) !== variable) {
                    newStructure.display.alias = (_k = oldDisplay === null || oldDisplay === void 0 ? void 0 : oldDisplay.vars_labels) === null || _k === void 0 ? void 0 : _k[key];
                }
            }
        }
        if (!((_l = newStructure.display) === null || _l === void 0 ? void 0 : _l.formula)) {
...
function isOldStructure(widget) {
    ...
    const isOld = !!(((_a = widget === null || widget === void 0 ? void 0 : widget.display) === null || _a === void 0 ? void 0 : _a.vars_labels) ||
        ...
        ((_d = widget === null || widget === void 0 ? void 0 : widget.display) === null || _d === void 0 ? void 0 : _d.gauge_type));
    return isOld;
}
