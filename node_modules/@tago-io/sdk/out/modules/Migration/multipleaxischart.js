    ...
    if (Array.isArray(oldWidget.data)) {
        ...
        for (const item of oldWidget.data) {
            ...
            for (const variable of item === null || item === void 0 ? void 0 : item.variables) {
                ...
                let chartType = ((_l = oldDisplay === null || oldDisplay === void 0 ? void 0 : oldDisplay.variables_chart) === null || _l === void 0 ? void 0 : _l[key]) || ((_m = oldDisplay === null || oldDisplay === void 0 ? void 0 : oldDisplay.variables_chart) === null || _m === void 0 ? void 0 : _m[reverseKey]);
                switch (chartType) {
                    case "spline":
                ...
                newStructure.display.variables.push(Object.assign(Object.assign(Object.assign(Object.assign({ color, origin: item.origin, variable }, (alias ? { alias } : {})), (numberFormat ? { number_format: numberFormat } : {})), (formula ? { formula } : {})), (chartType ? { chart_type: chartType } : {})));
            }
        }
    }
    return newStructure;
